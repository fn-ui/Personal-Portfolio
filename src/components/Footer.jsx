      ...
      <div className="relative z-10 mx-auto max-w-7xl">
              ...
              <div className="pt-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-slate-700 transition-all duration-300 hover:-translate-y-1 hover:border-blue-400 hover:bg-blue-50 hover:text-blue-600"
                  >
                    <FaGithub size={20} />
                  </a>
        ...
        <div className="mt-14 border-t border-slate-200 pt-8 text-center">
          ...
          <p className="text-sm text-slate-500">
            © {new Date().getFullYear()} Faith Njeri.
            All rights reserved.
          </p>
